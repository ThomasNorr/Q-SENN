...
def evaluateALLMetricsForComps(features_train, feature_maps_train, outputs_train, features_test, feature_maps_test,
                               outputs_test, linear_matrix, bias, labels_train):
